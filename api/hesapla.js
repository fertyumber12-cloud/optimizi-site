...
import { PIPES, SEPARATORS, MATS, VALVE_FACTORS, FUEL_PARAMS } from '../shared/constants.js';
import { validateInputs, hasBlockingError } from '../shared/validation.js';
...
export default function handler(req, res) {
    ...
    try {
        ...
        const validationErrors = validateInputs({ type, tProc, tAmb, matKey, thk, vWind, pDN, vDN, eff, hours, qty, pLen, useL2, matKey2, thk2, valveType });
        ...
        const warnings = validationErrors.filter(e => e.severity !== 'block');
