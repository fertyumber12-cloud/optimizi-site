(function() {
    ...
    // --- DÜZELTME BURADA ---
    // Scroll kilidini CSS yerine JS ile yapıyoruz ki sonra kaldırabilelim.
    document.body.style.overflow = 'hidden'; 

    // 2. CSS - Apple Style & Premium UI
    const style = document.createElement('style');
    style.innerHTML = `
        /* BURADAKİ body { overflow... } SATIRINI SİLDİK */
    ...
    function attemptLogin() {
        ...
        if(u === CONFIG.user && p === CONFIG.pass) {
            ...
            setTimeout(() => { 
                overlay.remove(); 
                // --- DÜZELTME BURADA ---
                // Başta JS ile kilitlediğimiz için şimdi JS ile açabiliriz.
