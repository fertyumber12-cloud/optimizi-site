// ============================================================================
// OPTİMİZİ - MERKEZİ MÜHENDİSLİK SABİTLERİ
...
// ─── CHILLER MALZEMELERİ ─── Sabit λ (düşük sıcaklık) ───
export const CHILLER_MATS = {
  rubber:    { k: 0.034, maxTemp: 105,  minTemp: -50,  name: "Elastomerik Kauçuk" },
  aerogel:   { k: 0.019, maxTemp: 650,  minTemp: -200, name: "Aerogel" },
  glasswool: { k: 0.032, maxTemp: 500,  minTemp: -50,  name: "Cam Yünü" },
  pu:        { k: 0.024, maxTemp: 100,  minTemp: -50,  name: "Poliüretan (PUR)" },
  bare:      { k: 25,    maxTemp: 9999, minTemp: -273, name: "Çıplak" }
};

// ─── VANA FAKTÖRLER (ısı kayıp çarpanları) ───
export const VALVE_FACTORS = {
...
export const CHILLER_VALVE_FACTORS = {
  gate: 1.2, globe: 1.4, butterfly: 0.6, ball: 1.0,
  strainer: 1.5, check: 0.9, flange: 0.4, elbow: 0.3
};
...
// ─── MINIMUM İZOLASYON KALINLIKLARI (mm) ───
// Üretilebilirlik sınırı: bu çapın altında bu kalınlık sarılamaz
...
// ─── YOĞUŞMA MALZEMELERİ (frontend) ───
export const CONDENSATION_MATS = [
